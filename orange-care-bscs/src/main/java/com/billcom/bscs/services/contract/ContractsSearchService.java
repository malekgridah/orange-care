...
import com.billcom.bscs.commons.beans.contract.search.ContractsSearchResponse;
...
public class ContractsSearchService {
    ...
    public ContractsSearchResponse contractsSearch(com.billcom.bscs.commons.beans.contract.search.ContractsSearchRequest searchRequest) {
    ...
    private InputAttributes prepareContractsSearchRequest(com.billcom.bscs.commons.beans.contract.search.ContractsSearchRequest searchRequest) {
    ...
    private ContractsSearchResponse prepareContractSearchResponse(com.ericsson.contractssearch.ContractsSearchResponse contractsSearchResponse,
                                                                  com.billcom.bscs.commons.beans.contract.search.ContractsSearchRequest searchRequest) {
