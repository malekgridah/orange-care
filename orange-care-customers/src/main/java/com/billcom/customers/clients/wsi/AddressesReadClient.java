...
public class AddressesReadClient {
    ...
    @Autowired
    public AddressesReadClient(WebServicesProperties webServiceConfig) {
    ...
    public void init() {
        try {
            ...
            String serviceUrl = webServiceConfig.getWsi().getUrl() + BaseWsWebService.ADDRESSES_READ;
    ...
    public AddressesReadResponse execute(AddressesReadRequest request) {
