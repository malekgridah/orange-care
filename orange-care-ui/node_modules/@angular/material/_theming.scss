...
$mat-dark-theme-background-orange: (
        status-bar: black,
        app-bar:    map_get($mat-orange-dark-tn, 900),
        background: #303030,
        hover:      rgba(white, 0.04), // TODO(kara): check style with Material Design UX
        card:       map_get($mat-orange-dark-tn, 800),
        dialog:     map_get($mat-orange-dark-tn, 800),
        disabled-button: rgba(white, 0.12),
        raised-button: map-get($mat-orange-dark-tn, 800),
        focused-button: $light-focused,
        selected-button: map_get($mat-orange-dark-tn, 900),
        selected-disabled-button: map_get($mat-orange-dark-tn, 800),
        disabled-button-toggle: black,
        unselected-chip: map_get($mat-orange-dark-tn, 700),
        disabled-list-option: black,
);
