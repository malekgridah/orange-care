...
import com.billcom.payment.commons.beans.invoices.*;
import com.billcom.payment.commons.beans.invoices.InvoiceResponse;
...
public class GetInvoicesV2 {
    ...
    @Autowired
    public GetInvoicesV2(FinancialDocumentSearchClient finDocSearchClient,
...
//        }
    ...
    private InvoiceResponse prepareInvoicesResponse(List<DocumentsListpartResponse> documentsList) {
        ...
        Map<Long, Map<Long, List<DocumentsListpartResponse>>> groupedByCustomerAndAccount = documentsList.stream()
                .collect(Collectors.groupingBy(
                        DocumentsListpartResponse::getCsId,
                        Collectors.groupingBy(
                                DocumentsListpartResponse::getBillingAccountId
                        )
                ));
        ...
        List<BillingAccountsByCustomer> billingAccountsByCustomer = new ArrayList<>();
